# Disaster Management System with React and MySQL
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Aniket-Chugh/disaster-managment-React-and-MySql.git
   cd disaster-managment-React-and-MySql
